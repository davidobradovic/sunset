        ...
        <div>
            <section style={{ minHeight: 'calc(100vh - 80px)' }} className="main-section flex items-center relative">
                ...
                <div className="image-container flex items-center justify-center w-1/2">
                    <img style={{ borderColor: '#FFCF73', width: '50%', height: 'calc(auto + 10px)', minWidth: 350 }} className='w-1/2 rounded-full border-4' src={`http://localhost:3001/upload/${homeDetails.map((m) => m.aboutImage)}`} alt="" />
                </div>
                ...
                <div style={{ gap: 5 }} className="list-of-images flex flex-wrap justify-center">
                    {
                        gallery.map((imgs) => {
                            return (
                                <img style={{ width: 'calc(100% / 5 - 5px)', minWidth: 250, height: 'auto' }} src={`http://localhost:3001/upload/${imgs.url}`} alt="" />
                            )
                        })
                    }
                </div>
